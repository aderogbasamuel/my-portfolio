          ...
          <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-gray-200 text-sm lg:text-lg">
                ...
                <br />
                <br />
                My journey in web development is fueled by a love for coding, an
                eye for design, and a commitment to continuous learning. Whether
                working on personal projects or collaborating with teams, I
