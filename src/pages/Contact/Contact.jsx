...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "d9e77dec-8803-4b44-8d86-04c708aa42bc"); // Replace with your Web3Forms access key
      ...
      <div className="hero min-h-screen flex items-center relative px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">developersamzy@gmail.com</p>
                  </div>
                </div>
            ...
            {/* Contact Form */}
            <div className="backdrop-blur-lg bg-white/5 p-4 sm:p-8 rounded-2xl shadow-xl">
